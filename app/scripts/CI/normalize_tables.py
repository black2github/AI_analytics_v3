...
def check_file(md_path: Path, min_valid_pct: float = 95.0,
    ...
    # README/frame (решение владельца 2026-08-30): README группы
    # экранной формы — чистая навигация (без frontmatter, вне сверки
    # по Р-9); содержимое уровня страницы (FLD/EV/B/MSG шапки, шаги
    # открытия/закрытия, контроли уровня формы) живёт в главной
    # карточке *.0-frame.md. README с frontmatter screen-form, несущий
    # предметные секции, — старая структура: ⚠ до структурного захода
    # frame, сторож тиража после него.
    if (md_path.name.lower() == "readme.md"
        ...
        report.append(
            ...
            "(FLD/EV/B/MSG) — по решению 2026-08-30 README — чистая "
            "навигация, содержимое уровня страницы переезжает в "
            "*.0-frame.md (структурный заход frame)")
