...
# ВАЖНО: ветка «любой символ» — [^\\\]], а НЕ [^\]]. Иначе бэкслеш матчится и веткой
# \\., и веткой «любой символ» одновременно — это пересечение даёт катастрофический
# бэктрекинг: на тексте с массой экранированных скобок (\[КК_ЛК\] ...) без последующего
# "](...)" движок перебирает экспоненту замощений и зависает на минуты. Исключив \ из
# «любого символа», оставляем бэкслеш только за \\. — неоднозначность снимается.
