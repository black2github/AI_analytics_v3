...
LLM_CONTEXT_SIZES = {
    ...
    'llama3.2:1b': 4000,
    'llama3.1:8b': 128000,
    'gpt-5.1': 128000, # Флагманская модель нового поколения — для сложных задач, кодинга, “agentic” задач и т.п
    'gpt-5.1-mini': 128000, # Более лёгкая и дешевая альтернатива GPT-5.1 — для задач средней сложности, массовых запросов, экономии бюджета.
    'gpt‑5.1‑nano': 128000, # Минимальный по цене вариант — для простых задач, трансформаций текста, классификаций, когда критична стоимость.
    'gpt‑4.1': 1048576,
