...
# Паттерн wiki-ссылки: [[Название страницы] ...] или [Название страницы]
# Нас интересует только текст в квадратных скобках — это title страницы
_WIKI_LINK_PATTERN = re.compile(
    r'\[\[([^\]]+)\]'   # [[Title] ...] — двойные скобки, берём первую группу
    r'|'
    r'\[([^\[\]]+)\]'   # [Title] — одиночные скобки
)
